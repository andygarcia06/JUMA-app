...
// Importer le module WebSocket (extraction dans websocket.js)
const { initWebSocket, broadcastToAssignedOrSubscribers } = require('./websocket');

// Création de l'application Express
const app = express();
const port = process.env.PORT || 3001;

// Création du serveur HTTP qui servira Express et WebSocket
  ...
  try {
    await mongoose.connect(
      process.env.MONGO_URI ||
        'mongodb+srv://andygarcia:Ansy9362!@cluster0.d0xzm.mongodb.net/Jumadb'
    );
...
// Initialisation du WebSocket en passant le serveur HTTP
initWebSocket(server);

// Route simple pour obtenir la version
app.get('/version', (req, res) => {
  res.json({ version: 'v40', commit: '6c3ab0cc' });
});

// Exemple de création d'un token
const userInfo = { id: 123, username: 'utilisateur' };
const token = jwt.sign(userInfo, 'votreCléSecrète');
