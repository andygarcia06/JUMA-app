...
app.use(cors({
  origin: function (origin, callback) {
    ...
    // Si l'origine est absente (requête interne) ou figure dans allowedOrigins
...
app.options('*', (req, res) => {
  ...
  console.log('> Préflight OPTIONS depuis :', requestOrigin);

  // Vérifie si l'origine est dans allowedOrigins
  if (!requestOrigin || allowedOrigins.includes(requestOrigin)) {
    ...
    console.log('> Préflight bloqué par CORS :', requestOrigin);
    return res.status(403).end('Not allowed by CORS');
  }
});
