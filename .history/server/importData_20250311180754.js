...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://andygarcia:Ansy9362!@cluster0.d0xzm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
const UserValidateCourse = require('./models/UserValidateCourse');
const DatabaseModel = require('./models/Database'); // Par exemple
const UserProgress = require('./models/UserProgress');
const ModuleTicket = require('./models/ModuleTicket');
const Module = require('./models/Module');
const Synonym = require('./models/Synonym');
const DBEntryTickets = require('./models/DBEntryTickets');
