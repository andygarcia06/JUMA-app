...
app.post('/projects/:projectId/functional', async (req, res) => {
  try {
    ...
    console.log(`🔍 Ajout du projet fonctionnel pour Project ID: ${projectId}, Tab ID: ${tabId}, Row ID: ${rowId}`);

    if (!companyId || !programId || !tabId || !rowId) {
      return res.status(400).json({ error: 'Tous les paramètres companyId, programId, tabId et rowId sont requis.' });
    }
    ...
    // Ajouter le projet fonctionnel à la row
