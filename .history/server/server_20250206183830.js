...
app.get('/api/pending-companies', (req, res) => {
  ...
  // 🔥 Vérification : Assurer que chaque entreprise a bien ses membres
  pendingCompanies = pendingCompanies.map(company => ({
    ...company,
    members: company.members ? company.members : [] // 🔥 Ajoute les membres s'ils manquent
  }));

  console.log("✅ Données envoyées après correction :", JSON.stringify(pendingCompanies, null, 2));
