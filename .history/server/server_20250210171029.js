...
const DB_MESSAGES_PATH = path.join(__dirname, "./json/ticketMessages.json");
...
app.get("/api/project-meteo/:ticketId", (req, res) => {
  ...
  console.log("📌 Type de allMessages:", typeof allMessages);
  console.log("📌 Contenu de allMessages:", allMessages);
  ...
  const ticketMessages = allMessages[ticketId]; // Accéder directement à l'objet
  if (!ticketMessages || !ticketMessages.messages) {
  ...
  console.log("📌 Messages du créateur trouvés:", creatorMessages.length);
