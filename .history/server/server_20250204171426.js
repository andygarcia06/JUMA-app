...
// Cette route reçoit une demande d'upgrade pour un utilisateur (identifié par son username)
...
// Elle reçoit dans le body le username et le nouveau rôle (newRole).
//
app.put('/update-role', (req, res) => {
  ...
  // Réinitialiser le flag upgradeRequested après la mise à jour
