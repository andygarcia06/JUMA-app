...
console.log("[SERVER] JSON file path:", filePath);
...
app.post('/upgrade-request', (req, res) => {
  ...
  // On cherche l'utilisateur dont la propriété "username" correspond
  ...
  // Mettre à jour le flag pour enregistrer la demande d'upgrade
  users[userIndex].upgradeRequested = true;
 ...
 * Cette route lit le fichier connectDatas.json et retourne la liste
 * des utilisateurs dont "upgradeRequested" est true et dont le rôle est "utilisateur".
 */
app.get('/upgrade-requests', (req, res) => {
  ...
  // Filtrer pour n'inclure que les utilisateurs qui ont demandé un upgrade et dont le rôle est "utilisateur"
...
/**
 * PUT /update-role
 * Cette route reçoit { username, newRole } dans le body.
 * Elle met à jour l'utilisateur correspondant en modifiant son rôle (ex: "admin")
 * et réinitialise le flag "upgradeRequested" à false.
 */
app.put('/update-role', (req, res) => {
  ...
  // Mettre à jour le rôle et réinitialiser le flag upgradeRequested
