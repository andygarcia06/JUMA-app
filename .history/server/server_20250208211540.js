...
// Route pour valider un ticketapp.post('/api/tickets/:ticketId/validate', (req, res) => {
    const { ticketId } = req.params;
    ...
    fs.readFile(dbFilePath, 'utf8', (err, data) => {
        ...
        // Met à jour l'état du ticket en fonction de l'action
        ...
        fs.writeFile(dbFilePath, JSON.stringify(tickets, null, 2), (err) => {
            ...
            res.json({ message: `Ticket ${action === "validate" ? "validé" : "mis en attente"}` });
        });
    });
});
