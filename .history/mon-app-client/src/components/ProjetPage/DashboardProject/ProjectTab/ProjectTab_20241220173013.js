...
const ProjectTab = ({ companyId, programId, projectId, tabId, tabName, userId }) => {
  ...
  const handleAddRow = async () => {
    console.log('Etat de newRow avant validation:', newRow);  // Affiche l'état de newRow
    ...
    console.log('Données envoyées pour ajouter une row:', payload);  // Vérifiez le payload
