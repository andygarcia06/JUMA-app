...
const ProjectTab = ({ companyId, programId, projectId, tabId, tabName, userId }) => {
  ...
  const handleAddRow = async () => {
    ...
    const payload = {
      ...newRow,
      tabId,       // Assurez-vous que tabId est correct ici
      tabName,     // Assurez-vous que tabName est correct ici
      projectId,
      programId,
      companyId,
      userId
    ...
    // Afficher les données dans la console pour vérifier ce qui est envoyé
