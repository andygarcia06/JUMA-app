                ...
                <tr>
                  <td colSpan="10">
                    <div className="project-under-row">
                      ...
                      <p><strong>Nom : </strong>{row.functionalProject.name}</p>
                      <p><strong>Gain Estimé : </strong>{row.functionalProject.estimatedGain}</p>
                      <p><strong>Type de projet : </strong>{row.functionalProject.projectType}</p>
                      <p><strong>Ressources nécessaires : </strong>{row.functionalProject.resourcesRequired}</p>
                      <p><strong>Date de début : </strong>{row.functionalProject.startDate}</p>
                      <p><strong>Date de fin : </strong>{row.functionalProject.endDate}</p>
                      <p><strong>Statut : </strong>{row.functionalProject.status}</p>
                    </div>
                  </td>
                </tr>
              )}
