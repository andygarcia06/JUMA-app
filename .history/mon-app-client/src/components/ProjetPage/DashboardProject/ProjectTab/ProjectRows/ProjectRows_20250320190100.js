...
const ProjectRows = ({ companyId, programId, projectId, tabId }) => {
  ...
  // Récupération des rows depuis le serveur
  useEffect(() => {
  ...
  // Gestion des changements dans le formulaire pour la nouvelle row
  ...
  // Gestion des changements dans le formulaire pour le projet fonctionnel
  ...
  const handleSubmitFunctionalProject = async (e) => {
    ...
    try {
      ...
      // Réinitialiser le formulaire et fermer le formulaire de projet fonctionnel
  ...
  // Toggle l'affichage du formulaire pour ajouter un projet fonctionnel
