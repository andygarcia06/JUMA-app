...
import AddProjectPopup from '../AddProjectPopup/AddProjectPopup'; // Popup pour ajouter un projet
import DashboardTickets from '../../DashboardTickets/DashboardTickets'; // DashboardTickets
import '../style.css';
...
const ProgramDetails = () => {
  ...
  // Extraction des données transmises via location.state
  ...
  return (
    <div className="program-details-container">
      ...
      {/* Affichage de la liste des membres du programme */}
      ...
      {/* Affichage de la liste des projets du programme */}
      ...
      {/* DashboardTickets pour afficher les tickets liés au programme */}
      <DashboardTickets 
         companyId={companyId} 
