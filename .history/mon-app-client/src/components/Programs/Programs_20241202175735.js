...
const Programs = ({ companyId, userId, companyData }) => {
  ...
  const handleMembersChange = (updatedMembers) => {
    console.log("Updated members:", updatedMembers); // Ajouter le console.log ici

    // Mettre à jour les membres dans Programs avec les membres mis à jour
  ...
  return (
    <div className="programs-container">
      ...
      <AddProgramPopup companyId={companyId} userId={userId} members={members}  onMembersChange={handleMembersChange} s/>
    </div>
  );
}
