...
import ModuleSuggestion from '../../ModuleSuggestion/ModuleSuggestion'; // Import du composant de suggestion de modules
  ...
  return (
    <div className="ticket-messages-container">
      ...
      <form className="message-form" onSubmit={handleSendMessage}>
        ...
        />
        <button type="submit">
          {editingMessage ? 'Ajouter au module' : 'Envoyer'}
        </button>
      </form>
      ...
      {/* Afficher le moduleTicket dans une popup */}
      {showModulePopup && (
        <ModulePopup content={moduleTicketContent} onClose={handleClosePopup} />
      )}
      <ModuleSuggestion
