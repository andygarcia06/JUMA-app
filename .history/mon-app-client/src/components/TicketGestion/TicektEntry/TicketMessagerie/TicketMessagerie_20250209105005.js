    ...
    <div className="ticket-container">
      ...
      <div className="ticket-header">
        <div className="ticket-header-left">
          <img src="/outlook-icon.png" alt="Outlook" className="ticket-icon" /> 
          <span className="ticket-status">Open #{ticketId}</span>
        </div>
  
        {/* ✅ Boutons de validation pour le créateur du ticket */}
      ...
      <div className="ticket-content">
        ...
        {/* ✅ ModuleSuggestion à droite */}
        <ModuleSuggestion
          className="matching-modules"
