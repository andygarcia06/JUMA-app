...
const TicketFields = () => {
  ...
  const [ticket, setTicket] = useState({
    ...
    markers: '',
    priority: '',
    // Stockez un objet Date ici pour éviter le problème de conversion
    ...
    axios.post('/api/tickets', ticketData)
      .then(response => {
        ...
        setTicket({
          ...
          markers: '',
          priority: '',
          creationDate: new Date(), // Nouvel objet Date
          userId: user ? user.pseudo : '',
          programName: programName || '',
          programId: programId || '',
          status: 'mis en attente'
    ...
    <div className='ticket-container'>
      <div className="ticket-fields ticket-section" id='ticket-fields'>
        ...
        <div className="ticket-field">
          ...
          <input
            type="text"
            value={ticket.creationDate.toString()} // Affichage de la date
            readOnly
          />
        </div>
