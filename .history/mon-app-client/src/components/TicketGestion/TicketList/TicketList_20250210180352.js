...
const TicketList = ({ companyName, user, programId, context = "default" }) => {
  ...
  const getTicketBackgroundColor = (meteo) => {
    switch (meteo) {
      case "☀️ Positive":
        return "green-background"; // Vert pour positif
      case "🌤 Neutre":
        return "yellow-background"; // Jaune pour neutre
      case "🌧 Négative":
        return "red-background"; // Rouge pour négatif
      default:
        return "grey-background"; // Gris pour indéterminé
    }
  };
