...
const EditProfile = ({ user, onClose }) => {
  ...
  // Utilisation de user.username ou user.userId comme identifiant
  const identifier = user.username || user.userId;
  console.log("EditProfile: identifier:", identifier);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('username', identifier);  // On envoie l'identifiant défini
