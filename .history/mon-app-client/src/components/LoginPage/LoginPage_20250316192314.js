...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      console.log("🔍 Réponse reçue du backend :", response.data); // Debug
      ...
      if (response.data.success) {
        ...
        // Dispatch avec pseudo et username en fallback
        dispatch(setUser({ 
          pseudo: response.data.pseudo || response.data.username, 
          ...response.data 
        }));
