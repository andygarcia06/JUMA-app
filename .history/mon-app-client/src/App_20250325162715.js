...
import UpdateUsersAdmin from './components/UpdateUsersAdmin/UpdateUsersAdmin';
import DbEnrichmentTicket from './components/DbEnrichmentTicket/DbEnrichmentTicket.js';
...
import EditProfile from './components/UserProfile/EditProfil/EditProfil.js'; // Assurez-vous d'avoir créé ce composant EditProfile
    ...
    <Router>
      <div>
        <Routes>
          ...
          <Route path="/update-users-admin" element={<UpdateUsersAdmin />} />
          <Route path="/db-enrichment-ticket" element={<DbEnrichmentTicket />} />
