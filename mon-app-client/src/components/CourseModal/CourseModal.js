    ...
    <div className="modal">
      <div className="modal-content">
        ...
        {showEditor ? (
          ...
          <div dangerouslySetInnerHTML={{ __html: editedContent }}></div>
        )}
        {!showEditor && (
          <button onClick={handleConsultCourse}>Valider le cours</button>
        )}
        {!showEditor && (
          <button onClick={handleEditCourse}>Modifier le cours</button>
        )}
